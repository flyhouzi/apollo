...
set apollo_config_db_url="jdbc:mysql://localhost:3307/ApolloConfigDB?characterEncoding=utf8"
set apollo_config_db_username="root"
set apollo_config_db_password="root"

rem apollo portal db info
set apollo_portal_db_url="jdbc:mysql://localhost:3307/ApolloPortalDB?characterEncoding=utf8"
